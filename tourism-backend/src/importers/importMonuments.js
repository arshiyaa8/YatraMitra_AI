  ...
  for (const m of monuments) {
    await Monument.findOneAndUpdate(
      { slug: m.slug },
      {
        ...
        foodNearby: m.foodNearby || [],
        lawsAndEtiquette: m.lawsAndEtiquette || [],
        accessibility: m.accessibility || { tags: ["wheelchair_accessible"] },
        entryFee: m.entryFee || { indian: 50, foreigner: 650, currency: "INR" },
        timings: m.timings || { openTime: "06:00", closeTime: "18:00", closedOn: [], bestVisitMonths: ["October", "November", "December", "January", "February", "March"], bestVisitTimeOfDay: "Early Morning or Sunset" },
        images: m.images || [],
